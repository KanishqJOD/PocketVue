      ...
      <div className="flex flex-col gap-10 text-foreground p-4 md:p-6">
        <header>
          ...
          <p className="text-md text-muted-foreground">
            Manage your profile and learn about PocketVue&apos;s AI capabilities.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-[#161b33] text-white flex flex-col">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Brain size={20} className="text-purple-400" /> About PocketVue AI
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 flex-grow text-sm text-white">
              <p className="text-muted-foreground">
                PocketVue is powered by advanced AI to give you smart, personalized financial insights.
              </p>
              ...
              <p className="text-muted-foreground">
                We&apos;re continuously enhancing PocketVue&apos;s capabilities to better serve you.
              </p>
            </CardContent>
          </Card>
        </div>
