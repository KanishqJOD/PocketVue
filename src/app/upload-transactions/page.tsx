        ...
        <Card className="bg-[#161b33] shadow-lg border-none">
          <CardContent className="p-6">
            ...
            {transactions.length > 0 ? (
              <div className="bg-white rounded-xl shadow-md p-4 mb-4 text-left text-black">
                ...
                <div className="max-h-[300px] overflow-auto rounded-lg">
                  <table className="w-full text-sm text-left border border-gray-200 rounded-md overflow-hidden">
                    <thead className="bg-gray-100 text-gray-900 font-medium sticky top-0 z-10">
                      <tr>
                    ...
                    <tbody>
                      {transactions.map((tx, i) => (
                        ...
                        >
                          <td className="px-3 py-2 text-black">{tx.date}</td>
                          ...
                          <td className="px-3 py-2">
                            <span
                              className={`text-xs px-2 py-1 rounded-full font-medium ${tx.type === "CR" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                            >
                          ...
                          <td className="px-3 py-2">
                            <span
                              className={`text-xs px-2 py-1 rounded-full font-medium ${tx.classifiedAs === "Income" ? "bg-blue-100 text-blue-700" : "bg-yellow-100 text-yellow-700"}`}
                            >
                              {tx.classifiedAs}
                            </span>
                          </td>
